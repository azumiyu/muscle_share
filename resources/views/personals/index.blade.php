...
<div class="container">
	...
	<div class="content">
	    <a class="js-modal-open common-submit">体重記録追加</a>
	</div>
	<div class="modal js-modal">
	    ...
	    <div class="modal__content">
	        <form action="/personals" method="POST">
	        	@csrf
	        	<p>記録日と体重を入力します。体重には最新日の記録が残っています。</p>
	        	<label for ="date">日付</label>
	        	<input id = "date" type="date" name="personal[date_key]" min="2000-01" max="2100-12" value="{{ date('Y-m-d') }}"><br>
